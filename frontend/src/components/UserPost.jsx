                ...
                <Flex gap={3} mb={4} py={5}>
                    <Flex flexDirection={"column"} alignItems={"center"}>
                        ...
                        <Box position={"relative"} w={"full"}>
                            <Avatar size="xs" name="John doe" src='https://bit.ly/code-beast' position={"absolute"} top={"0px"} left="15px" padding={"2px"} />
                            <Avatar size="xs" name="John doe" src='https://bit.ly/prosper-baba' position={"absolute"} bottom={"0px"} right="-5px" padding={"2px"} />
                            <Avatar size="xs" name="John doe" src='https://bit.ly/ryan-florence' position={"absolute"} bottom={"0px"} left="4px" padding={"2px"} />
                        </Box>
                    </Flex>
